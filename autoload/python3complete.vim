...
"
" this file contains adaptations for python3 and is parallel to pythoncomplete.vim
"
" Changes
" TODO:
    " 'info' item output can
        " use some formatting work

    " Add an "unsafe eval" mode,
        " to allow for return type evaluation
