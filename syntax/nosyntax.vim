...
" Remove all autocommands for the Syntax event.
" This also avoids that  "syntax=foo" in a modeline
" triggers the SynSet() function of synload.vim.
...
if exists("syntax_on")  | unlet syntax_on  | endif
if exists("syntax_manual")  | unlet syntax_manual  | endif
