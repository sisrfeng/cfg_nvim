...
if !exists('b:did_scheme_syntax')  | finish  | endif
...
" Notes: This is supplemental syntax,
    " to be loaded after the core Scheme  syntax file (syntax/scheme.vim).
    " Enable it by setting b:is_chicken=1
" and filetype=scheme.
