" Language:        AsciiDoc
"\ tig的readme用到这语言
    "\ AsciiDoc aims to provide an easy-to-read,
    "\ what-you-see-is-what-you-get syntax.
    "\ It attains this goal by
    "\ making most indentation insignificant,
    "\ using clear block boundaries,
    "\ and relying on conventional notation.
    "\ AsciiDoc is composed of
    "\ a few patterns,
    "\ such as delimited blocks,
    "\ macros,
    "\ and formatting pairs.
    "\ A newcomer can pick up the syntax mostly by
    "\ intuition alone.

    " Maintainer:      @aerostitch on GitHub (tag me in your issue in the
    "                  github/vim/vim repository and I'll answer when available)
    " Original author: Stuart Rackham <srackham@gmail.com> (inspired by Felix  Obenhuber's original asciidoc.vim script).
...
" Limitations:
    ...
    " - If a closing Example Block delimiter may be mistaken for a title  underline.
        "   A workaround is to insert a blank line before the closing
    "   delimiter.
