" Language: crontab
    ...
    " Filenames: /tmp/crontab.*
    "\ used by `crontab -e`
    " Last Change: 2015-01-20
"
" crontab line format:
" Minutes   Hours   Days   Months   Days_of_Week   Commands # comments
                                                            "\ 但是 /home/wf/Man/crontab__5.mm里说,不能有行末注释
...
syntax case ignore
    ...
    syntax  match   crontabCmnt     "^\s*#.*" contains=@Spell
            ...
            "\ /home/wf/Man/crontab__5.mm
                "\ Lines whose first non-space character is a hash-sign (#)  are comments,
                "\ and are ignored.
                "\ Note that comments are not allowed on the same line as cron commands,
                "\     since they will be taken to be part of the command.
                "\ Similarly,
